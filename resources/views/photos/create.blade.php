...
<form method="POST" action="{{route('photos.store')}}">
    ...
    <div class="form-group">
        ...
        <div style="display: flex">
            <input id="url" type="text" class="form-control" name="url" placeholder="Url" value="{{ old('url') }}"
                readonly>
            &nbsp;&nbsp;
    ...
    <div class="form-group">
        ...
        <br>
        <img id="photo-preview" class="photo-preview" style="display:none" src="{{ old('url') }}" alt="" srcset=""
